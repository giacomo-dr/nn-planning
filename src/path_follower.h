...
#define  PF_DEFAULT_MAX_ANGULAR_ACC 10.0
#define  PF_DEFAULT_PATH_BLENDING 0.01
#define  PF_DEFAULT_INPLACE_ROTATION_THRESHOLD 100
#define  PF_DEFAULT_ANGLE_TOLERANCE 0.02
